 ...
 */
 ...
 /*
 * The following code block enables the database connection to Cloud Foundry.
 * If a local.settings.php file exists, it will read that instead so make sure
 * that that file is not pushed to CF.
 *
 ...
 * @endcode
 */
$settings['hash_salt'] = 'dQw0JWvRmj8iwF_4HOCXaD4D8oszbi0qnU8uwIqfDvCNGARpmx2Zkq2ez7kFvPg6unm_zlRHqQ';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_dta_gov_au_local_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_dta_gov_au_local_dd.inc';
}
// </DDSETTINGS>
