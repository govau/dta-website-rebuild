...
/**
 * @file
 * Definition of \Drupal\editor_experience\Plugin\CKEditorPlugin\FakeObjects.
 */
...
class FakeObjects extends CKEditorPluginBase {
   ...
   */
  function getFile() {
    return drupal_get_path('module', 'editor_experience') . '/js/plugins/fakeobjects/plugin.js';
  }
